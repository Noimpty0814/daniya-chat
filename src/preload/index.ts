...
const api: Api = {
  ...
  pickFiles: (conversationId) => ipcRenderer.invoke('file:pick', { conversationId }),
  registerFiles: (conversationId, paths) => ipcRenderer.invoke('file:register', { conversationId, paths }),
